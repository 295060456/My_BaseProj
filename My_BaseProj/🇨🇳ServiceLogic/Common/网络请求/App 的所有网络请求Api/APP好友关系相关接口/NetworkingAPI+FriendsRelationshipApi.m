...
withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.addAwardGET.url;
...
+(void)addAwardInfoGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.addAwardInfoGET.url;
...
+(void)awardListGET:(id)parameters
   withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.awardListGET.url;
...
+(void)fourListGET:(id)parameters
  withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.fourListGET.url;
...
+(void)friendUrlselectUrlGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.friendUrlselectUrlGET.url;
...
+(void)userFriendListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.userFriendListGET.url;
...
+(void)myInComeGET:(id)parameters
  withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.myInComeGET.url;
...
+(void)savePhonePOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.savePhonePOST.url;
