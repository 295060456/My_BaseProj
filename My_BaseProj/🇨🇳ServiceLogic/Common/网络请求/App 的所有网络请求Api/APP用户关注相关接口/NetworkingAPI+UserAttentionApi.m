//
//  NetworkingAPI+UserAttentionApi.m
//  MonkeyKingVideo
//
...
#import "NetworkingAPI+UserAttentionApi.h"
/*
各种环境的地址 和 接口文档地址 在这里写，方便调用
 
 */
@implementation NetworkingAPI (UserAttentionApi)
...
+(void)userFocusAddPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.userFocusAddPOST.url;
...
+(void)userFocusDeleteGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.userFocusDeleteGET.url;
...
+(void)userFocusListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.userFocusListGET.url;
