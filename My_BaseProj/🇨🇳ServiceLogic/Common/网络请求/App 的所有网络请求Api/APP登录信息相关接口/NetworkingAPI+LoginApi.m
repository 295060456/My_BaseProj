...
+(void)changePasswordPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.changePasswordPOST.url;
...
+(void)checkIdentityPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.checkIdentityPOST.url;
...
+(void)appLoginPOST:(id)parameters
   withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.appLoginPOST.url;
...
+(void)appLogoutGET:(id)parameters
   withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.appLogoutGET.url;
...
+(void)randCodeGET:(id)parameters
  withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.randCodeGET.url;
...
+(void)appRegisterPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.appRegisterPOST.url;
...
+(void)resetPasswordPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.resetPasswordPOST.url;
...
+(void)sendSmsCodePOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.sendSmsCodePOST.url;
