...
#import "NetworkingAPI+EarnApi.h"
/*
各种环境的地址 和 接口文档地址 在这里写，方便调用
 
 */
@implementation NetworkingAPI (EarnApi)
...
+(void)boxRewardPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.boxRewardPOST.url;
...
+(void)goldSwitchGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.goldSwitchGET.url;
...
+(void)goldSwitchPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.goldSwitchPOST.url;
...
+(void)randomRewardPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.randomRewardPOST.url;
...
+(void)rewardSnapshotGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.rewardSnapshotGET.url;
...
+(void)rewardSnapshotPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.rewardSnapshotPOST.url;
