...
#import "NetworkingAPI+CommentApi.h"
/*
各种环境的地址 和 接口文档地址 在这里写，方便调用
 
 */
@implementation NetworkingAPI (CommentApi)
...
+(void)commentVideoPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.commentVideoPOST.url;
...
withsuccessBlock:(MKDataBlock)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.delCommentPOST.url;
...
+(void)queryInitListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.queryInitListGET.url;
...
+(void)queryReplyListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.queryReplyListGET.url;
...
+(void)replyCommentPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.replyCommentPOST.url;
...
+(void)setPraisePOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.setPraisePOST.url;
