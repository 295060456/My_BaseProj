...
#import "NetworkingAPI+BlankList.h"
/*
各种环境的地址 和 接口文档地址 在这里写，方便调用
 
 */
@implementation NetworkingAPI (BlankList)
...
+(void)blackListAddPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.blackListAddPOST.url;
...
+(void)blackListDeleteGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.blackListDeleteGET.url;
...
+(void)blackListGET:(id)parameters
   withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.blackListGET.url;
