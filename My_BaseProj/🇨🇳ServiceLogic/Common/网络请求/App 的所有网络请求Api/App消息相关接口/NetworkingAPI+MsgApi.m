...
#import "NetworkingAPI+MsgApi.h"
/*
各种环境的地址 和 接口文档地址 在这里写，方便调用
 
 */
@implementation NetworkingAPI (MsgApi)
...
+(void)fansInfoGET:(id)parameters
  withsuccessBlock:(MKDataBlock _Nullable)successBlock{
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.fansInfoGET.url;
...
+(void)messageFirstClassListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.messageFirstClassListGET.url;
...
+(void)messageInfoGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.messageInfoGET.url;
...
+(void)messageSecondClassListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.messageSecondClassListGET.url;
...
+(void)noticeListappGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.noticeListappGET.url;
...
+(void)turnOffListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.turnOffListGET.url;
...
+(void)updateOffPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.updateOffPOST.url;
