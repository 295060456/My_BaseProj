...
#import "NetworkingAPI+StatisticsApi.h"
/*
 各种环境的地址 和 接口文档地址 在这里写，方便调用
 
 */
@implementation NetworkingAPI (StatisticsApi)
...
+(void)addActiveUserDataPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.url = NSObject.addActiveUserDataPOST.url;
...
+(void)addStartTimePOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.addStartTimePOST.url;
...
+(void)addUseTimeDataPOST:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.addUseTimeDataPOST.url;
...
+(void)channelListGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.channelListGET.url;
...
+(void)versionInfoAppGET:(id)parameters
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl_1;
        request.url = NSObject.versionInfoAppGET.url;
