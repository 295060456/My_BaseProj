...
#import "UBLDoorInputViewStyle_4.h"

@interface UBLDoorInputViewStyle_4 ()
<
UITextFieldDelegate
>
...
@property(nonatomic,copy)FourDataBlock doorInputViewStyle_4Block;

@end

@implementation UBLDoorInputViewStyle_4
...
#warning 过滤删除最科学的做法
    ...
    if (self.doorInputViewStyle_4Block) {
        self.doorInputViewStyle_4Block(self,
                                       textField,
                                       resString,
...
-(void)actionBlockDoorInputViewStyle_4:(FourDataBlock)doorInputViewStyle_4Block{
...
-(ImageCodeView *)imageCodeView{
    if (!_imageCodeView) {
        ...
        [self layoutIfNeeded];
        [UIView cornerCutToCircleWithView:_imageCodeView AndCornerRadius:self.mj_h / 2];
